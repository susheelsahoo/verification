                ...
                <div class="col-md-6 mt-5 mb-3">
                    <div class="card">
                        <div class="seo-fact sbg1">
                            <a href="{{ route('admin.case.caseStatus', ['id' => '1']) }}">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 'aaa', 'user_id' => $userWise['agentid']])  }}">{{ $userWise['total'] ?? 0 }}</a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 1, 'user_id' => $userWise['agentid']]) }}">{{ $userWise['inprogress'] ?? 0 }}</a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 2, 'user_id' => $userWise['agentid']]) }}">{{ $userWise['positive_resolved'] ?? 0 }} </a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 3, 'user_id' => $userWise['agentid']]) }}">{{ $userWise['negative_resolved'] ?? 0 }}</a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 4, 'user_id' => $userWise['agentid']]) }}">{{ $userWise['positive_verified'] ?? 0 }}</a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 5, 'user_id' => $userWise['agentid']]) }}">{{ $userWise['negative_verified'] ?? 0 }} </a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 6, 'user_id' => $userWise['agentid']]) }}">{{ $userWise['hold'] ?? 0 }} </a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 1, 'user_id' => $userWise['agentid']]) }}">{{ 0 }}</a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 1]) }}">{{ 0 }} </a></td>
                    <td><a href="{{ route('admin.case.caseStatus', ['status' => 1]) }}">{{ 0 }} </a></td>
                    <td><i class='fa fa-map-marker fa-2x' style='color:#9b479f;'></i></td>
                </tr>
