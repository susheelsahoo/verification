    ...
    <form action="{{ route('admin.case.modifyCase.viewCase', $case->id) }}" method="POST">
        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <td>Type of Proof</td>
                    <td colspan="3" class="BVstyle ng-binding"><input type="text" name="type_of_proof" class="form-control" value=" {{ $case->type_of_proof ?? 'NA' }}" /> </td>
                </tr>
                <tr>
                    <td>Address Confirmed By</td>
                    <td colspan="3" class="BVstyle ng-binding ng-hide"><input type="text" name="address_confirmed_by" class="form-control" value=" {{ $case->address_confirmed_by ?? 'NA' }}" /> </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="BVstyle ng-binding"><input type="text" name="name_of_employer" class="form-control" value="{{ $case->name_of_employer ?? 'NA' }}" /> </td>
                    <td>Person Met</td>
                    <td class="BVstyle ng-binding"><input type="text" name="person_met" class="form-control" value="{{ $case->person_met ?? 'NA' }}" /> </td>
                </tr>
                <tr>
                    <td>Address of Employer/Co</td>
                    <td colspan="3" class="BVstyle ng-binding"><input type="text" name="employer_address" class="form-control" value="{{ $case->employer_address ?? 'NA' }}" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="BVstyle ng-binding ng-hide"><input type="text" name="telephone_no_residence" class="form-control" value="{{ $case->telephone_no_residence ?? 'NA' }}" /> </td>
                    <td>Mobile Number</td>
                ...
                <tr>
                    ...
                    <td class="BVstyle ng-binding ng-hide"><input type="text" name="applicant_age" class="form-control" value="{{ $case->applicant_age ?? '0' }}" /></td>
                    <td>Name of Employer/Co</td>
                    <td class="BVstyle ng-binding ng-hide">{{ $case->applicaname_of_employernt_age ?? 'NA' }}</td>
                </tr>
                <tr>
                    <td>Co/Established in(Year)</td>
                    <td class="BVstyle ng-binding ng-hide">0000</td>
                    <td>Designation</td>
                    <td class="BVstyle ng-binding ng-hide"><input type="text" name="designation" class="form-control" value="{{ $case->designation ?? 'NA' }}" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Area</td>
                    <td class="BVstyle ng-binding ng-hide"><input type="text" name="area" class="form-control" value="{{ $case->area ?? 'NA' }}" /></td>
                    <td>Nearest Landmark</td>
                    <td class="BVstyle ng-binding ng-hide"><input type="text" name="nearest_landmark" class="form-control" value="{{ $case->nearest_landmark ?? 'NA' }}" /></td>
                </tr>
